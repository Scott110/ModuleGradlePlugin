...
import com.zto.gradleplugin.extend.ModuleExtension
import org.gradle.api.Plugin
import org.gradle.api.Project
import org.gradle.api.Task

public class ModuleBuild implements Plugin<Project> {

    //默认是app，直接运行assembleRelease的时候，等同于运行app:assembleRelease
    String compilemodule = "app"

    void apply(Project project) {
        project.extensions.create('modulebuild', ModuleExtension)
        ...
        if (isRunAlone) {
            ...
            if (assembleTask.isAssemble && module.equals(compilemodule)) {
                ...
                project.android.registerTransform(new ModuleCodeTransform(project))
            }
        } else {
